...
Additionally, we also simulated a continuous grid of $\alpha$ values in $[0.5, 1)$ with: `alpha_bci_optim_grid.sh` 
...
Usage example:
```
sh scripts/simulations/bash/alpha_bci_optim_grid.zsh scripts/simulations/bci_optim.py Won preproc/won/all Won_ITR_GCB_Repr -1
```
...
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Hoffmann preproc/hoff/all "HoffStudy" -1
```

To generate all results from Won et. al. into a file called `WonStudy.db`:
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Won preproc/won/all "WonStudy" -1
```

To generate all results from Won et. al. into a file called `WonRCP2RSVStudy.db`: (treating it as a Stimulus-Level paradigm)
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py WonRCP2RSVP preproc/won/all "WonRCP2RSVPStudy" -1
```
...
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Hoffmann preproc/hoff/hoff16 "HoffStudy_ElectSet - hoff16" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Hoffmann preproc/hoff/hoff8 "HoffStudy_ElectSet - hoff8" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Hoffmann preproc/hoff/hoff4 "HoffStudy_ElectSet - hoff4" -1
```

To generate all results from Won et. al.:
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Won preproc/won/won16 "WonStudy_ElectSet - won16" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Won preproc/won/won8 "WonStudy_ElectSet - won8" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py Won preproc/won/won4 "WonStudy_ElectSet - won4" -1
```

To generate all results from Won et. al.: (treating it as a Stimulus-Level paradigm)
```sh
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py WonRCP2RSVP preproc/won/won16 "WonRCP2RSVPStudy_ElectSet - won16" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py WonRCP2RSVP preproc/won/won8 "WonRCP2RSVPStudy_ElectSet - won8" -1
sh scripts/simulations/bash/optimize_all_bci.sh Optuna/Optimization/bci_optim.py WonRCP2RSVP preproc/won/won4 "WonRCP2RSVPStudy_ElectSet - won4" -1
```
...
For Hoffmann:
```sh
sh ITR_GCB_Repr/scripts/alpha_bci_optim_grid.sh Optuna/Optimization/bci_optim.py Hoffmann preproc/hoff/all Hoff_ITR_GCB_Repr -1
```

For Won:
```sh
sh ITR_GCB_Repr/scripts/alpha_bci_optim_grid.sh Optuna/Optimization/bci_optim.py Won preproc/won/all Won_ITR_GCB_Repr -1
```

For WonRCP2RSVP:
```sh
sh ITR_GCB_Repr/scripts/alpha_bci_optim_grid.sh Optuna/Optimization/bci_optim.py WonRCP2RSVP preproc/won/all WonRCP2RSVP_ITR_GCB_Repr -1
```
